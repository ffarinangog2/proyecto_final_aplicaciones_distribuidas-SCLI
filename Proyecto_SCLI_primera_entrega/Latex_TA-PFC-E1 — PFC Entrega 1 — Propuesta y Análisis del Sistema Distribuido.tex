...
\definecolor{uteqBlue}{RGB}{20,60,120}
...
{\Huge\bfseries
Sistema Distribuido para el Control
}

\vspace{0.2cm}

{\Huge\bfseries
y Administración de Laboratorios
}

\vspace{0.2cm}

{\Huge\bfseries
Informáticos en Entornos Académicos
}
...
\textbf{Freddy Vladimir Farinango Guandinango}

Arquitecto

\vspace{0.4cm}

\textbf{Isaías Abraham Urbina Romero}

Líder de desarrollo

\vspace{0.4cm}

\textbf{Iván Andrés Villamarín Cuenca}

Responsable de calidad

\vspace{0.4cm}

\textbf{Harold Nicolás Vinueza Sánchez}
...
Aplicaciones distribuidas; sistemas de gestión; arquitectura cliente-servidor;

\vspace{0.01cm}

procesamiento concurrente; sistemas web; PostgreSQL; Spring Boot.
...
distributed applications; management systems; client-server architecture; 

\vspace{0.01cm}

concurrent processing; web systems; PostgreSQL; Spring Boot.
...
Finalmente, el documento se organiza en varias secciones relacionadas con el desarrollo de la propuesta. En primer lugar, se presenta el estado del arte sobre sistemas de gestión de laboratorios y aplicaciones distribuidas. Por último, se exponen los objetivos y las posibles líneas de trabajo futuro.
...
\caption{Comparación de investigaciones relacionadas con sistemas distribuidos}
\\
...
\color{white}\textbf{Cita}
&
\color{white}\textbf{Autores}
&
\color{white}\textbf{Año}
&
\color{white}\textbf{Método}
&
\color{white}\textbf{Contexto/Dataset}
&
\color{white}\textbf{Métricas}
&
\color{white}\textbf{Limitaciones}
...
Cámaras y redes distribuidas&
Privacidad y tolerancia a fallos&
No orientado a educación\\

[2]&Syed et al.&2021&
Acoplamiento distribuido en tiempo real&
Infraestructuras geográficamente distribuidas&
Sincronización y rendimiento&
Aplicado a smart grids\\

[3]&Saleem et al.&2020&
Framework de seguridad distribuida&
Sistemas energía y control&
Seguridad y disponibilidad&
Enfoque energético\\

[4]&Peng et al.&2021&
Control distribuido por eventos&
Microredes DC&
Escalabilidad y estabilidad&
Infraestructura especializada\\

[5]&Deng y Yang&2019&
Control adaptativo tolerante fallos&
Sistemas multiagente lineales&
...
Sistemas lineales&
Tiempo respuesta&
No integra módulos académicos\\

[7]&Casimiro et al.&2020&
...
[8]&Xu et al.&2020&
Caché distribuida servicios&
Mobile edge-clouds&
Acceso concurrente&
No aplicado educación\\

[9]&Mousavi et al.&2020&
...
[10]&Li et al.&2021&
Cadenas Markov difusas&
Sistemas inteligentes&
Modelado y observación&
No gestión académica\\

[11]&Wang et al.&2020&
Gestión distribuida recursos&
Hardware-in-the-loop&
Rendimiento evaluación&
Aplicación smart grids\\

[12]&Ridgley et al.&2020&
Promedio distribuido privado&
Sistemas distribuidos&
Privacidad sincronización&
No enfocado educación\\

[13]&Al-Saffar et al.&2020&
Gestión con aprendizaje reforzado&
Alta penetración PV&
Mitigación sobrevoltaje&
Contexto energético\\

[14]&Stafford y Treiblmaier&2020&
Blockchain distribuido&
Registros médicos&
Compartición segura&
No aplicado laboratorios\\

[15]&Batalla&2020&
Transmisión distribuida video&
Redes WiFi y 5G&
Calidad transmisión&
Enfoque IIoT\\
...
\item •	Integrar módulos distribuidos para reservas, asistencia, inventario y reportes técnicos.

\item •	Implementar comunicación entre servicios para compartir información en tiempo real.

\item •	Permitir el acceso concurrente de múltiples usuarios sin afectar el rendimiento del sistema.

\item •	Separar funciones del sistema en módulos independientes para mejorar la escalabilidad y mantenimiento.

\item •	Validar el funcionamiento coordinado de los módulos distribuidos dentro de la red universitaria.
...
[15]	J. M. Batalla, “On Analyzing Video Transmission over Wireless WiFi and 5G C-Band in Harsh IIoT Environments,” IEEE Access, vol. 8, pp. 118534–118541, 2020, doi: 10.1109/ACCESS.2020.3005641.

\vspace{0.2cm}
% ====== LINK DEL REPOSITORIO ======
\subsection*{Repositorio GitHub}

\href{https://github.com/ivillamarinc/aplicaciones-distribuidas}{https://github.com/ivillamarinc/aplicaciones-distribuidas}
\end{document}